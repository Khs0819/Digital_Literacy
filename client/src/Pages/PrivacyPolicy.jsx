    ...
    <div className="bg-gray-900 text-white min-h-screen">
      ...
      <div className="lg:w-3/4 w-full block m-auto">
        <div className="container mx-auto px-4 py-8">
          ...
          <p className="mb-4">
            Welcome to Digital Literacy. We are committed to protecting your
          ...
          <div className="mb-4">
            ...
            <p className="ml-6">
              - Register or create an account on Digital Literacy.
            </p>
            <p className="ml-6">- Select elective subjects.</p>
            <p className="ml-6">
              - Communicate with us through customer service or other channels.
            </p>
            <p className="ml-6">- Use any of our services.</p>
            <p>
              This information may include your name, email address, phone
              number, date of birth, student ID, and other relevant details.
            </p>
          </div>
          <br />
          ...
          <div className="mb-4">
            <p>
              We may also collect non-personal information that cannot be used
              to identify you, such as:
            </p>
            <p className="ml-6">- Browser type and version.</p>
            <p className="ml-6">- Device type and operating system.</p>
            <p className="ml-6">- IP address.</p>
            <p className="ml-6">
              - Usage data, including the date and time of your visits to
              Digital Literacy and your activities on the site.
            </p>
          </div>
          <br />
          ...
          <div className="mb-4">
            ...
            <p className="ml-6">
              - Improve and personalize your experience on Digital Literacy.
            </p>
            <p className="ml-6">
          ...
          <div className="mb-4">
            ...
            <p className="ml-6">
              ...
              email delivery, and hosting services.
            </p>
            <p className="ml-6">
          ...
          <p>
            ...
            <a
              href="mailto:Digital Literacy@supprt.com"
